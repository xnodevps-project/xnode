...
The xnode project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/xnodevps-project/xnode/blob/master/doc/translation_process.md)
...
The following applies to code changes to the xnode project, and is not to be
confused with overall xnode Network Protocol consensus changes.

Whether a pull request is merged into xnode rests with the project merge
...
Patches that change xnode consensus rules are considerably more involved than
...
Where a patchset proposes to change the xnode consensus, it must have been
...
The project leader is the release manager for each xnode release.
