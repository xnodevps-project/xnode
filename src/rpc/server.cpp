...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop xnode Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "xnode Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* xnode features */
        {"xnode", "listmasternodes", &listmasternodes, true, true, false},
        {"xnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xnode", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"xnode", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"xnode", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"xnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xnode", "masternodedebug", &masternodedebug, true, true, false},
        {"xnode", "startmasternode", &startmasternode, true, true, false},
        {"xnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xnode", "preparebudget", &preparebudget, true, true, false},
        {"xnode", "submitbudget", &submitbudget, true, true, false},
        {"xnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xnode", "checkbudgets", &checkbudgets, true, true, false},
        {"xnode", "mnsync", &mnsync, true, true, false},
        {"xnode", "spork", &spork, true, true, false},
...
{
    return "> xnode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7776/\n";
}
