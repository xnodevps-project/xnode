...
/* xnode GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "xnode Coin"
#define QAPP_ORG_DOMAIN "xnode.trade"
#define QAPP_APP_NAME_DEFAULT "xnode Coin-Qt"
#define QAPP_APP_NAME_TESTNET "xnode Coin-Qt-testnet"
