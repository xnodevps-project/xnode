...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            xnodeGUI* window = static_cast<xnodeGUI*>(parentWidget());
...
{
    xnodeGUI* gui = static_cast<xnodeGUI*>(parentWidget());
...
{
    hide();
    static_cast<xnodeGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("xnode Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your XNODEs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
