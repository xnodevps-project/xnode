...
#include "qt/xnode/topbar.h"
#include "qt/xnode/forms/ui_topbar.h"
#include "qt/xnode/lockunlock.h"
#include "qt/xnode/qtutils.h"
#include "qt/xnode/receivedialog.h"
#include "qt/xnode/loadingdialog.h"
...
TopBar::TopBar(xnodeGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopXNODE}, "amount-small-topbar");
    setCssProperty({ui->labelAmountXNODE}, "amount-topbar");
    setCssProperty({ui->labelPendingXNODE, ui->labelImmatureXNODE}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // XNODE Total
    QString totalXNODE = GUIUtil::formatBalance(balance, nDisplayUnit);

    // XNODE
    // Top
    ui->labelAmountTopXNODE->setText(totalXNODE);
    // Expanded
    ui->labelAmountXNODE->setText(totalXNODE);
    ui->labelPendingXNODE->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureXNODE->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
