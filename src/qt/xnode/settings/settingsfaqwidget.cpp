...
#include "qt/xnode/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/xnode/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(xnodeGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableXNODE,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableXNODE,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableXNODE,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableXNODE,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableXNODE, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableXNODE);});
    ...
    if (parent)
        connect(parent, &xnodeGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
