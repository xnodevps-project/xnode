...
#include "qt/xnode/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/xnode/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(xnodeGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the xnode Coin RPC console.") + "<br>" +
