...
#include "qt/xnode/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(xnodeGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &xnodeGUI::openFAQ);
