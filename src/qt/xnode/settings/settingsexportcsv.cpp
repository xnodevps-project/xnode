...
#include "qt/xnode/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(xnodeGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("xnode_tx_csv_export(*.csv)") : tr("xnode_addresses_csv_export(*.csv)"),
                                        nullptr);
