...
#include "qt/xnode/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/xnode/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(xnodeGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to xnodeGUI::handleRestart()
