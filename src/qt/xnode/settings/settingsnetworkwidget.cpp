...
#include "qt/xnode/settings/settingsnetworkwidget.h"
#include "qt/xnode/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/xnode/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(xnodeGUI* _window, QWidget *parent) :
