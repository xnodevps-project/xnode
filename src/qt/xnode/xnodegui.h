...
#ifndef xnode_CORE_NEW_GUI_xnodeGUI_H
#define xnode_CORE_NEW_GUI_xnodeGUI_H
...
#include "qt/xnode/navmenuwidget.h"
#include "qt/xnode/topbar.h"
#include "qt/xnode/dashboardwidget.h"
#include "qt/xnode/send.h"
#include "qt/xnode/receivewidget.h"
#include "qt/xnode/addresseswidget.h"
#include "qt/xnode/coldstakingwidget.h"
#include "qt/xnode/masternodeswidget.h"
#include "qt/xnode/snackbar.h"
#include "qt/xnode/settings/settingswidget.h"
...
/**
  xnode GUI main class. This class represents the main window of the xnode UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class xnodeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit xnodeGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~xnodeGUI();
...
#endif //xnode_CORE_NEW_GUI_xnodeGUI_H
