...
#include "qt/xnode/sendcustomfeedialog.h"
#include "qt/xnode/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(xnodeGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &xnodeGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
