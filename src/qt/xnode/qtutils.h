...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, xnodeGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, xnodeGUI* gui, double posX = 3);
