...
/** Utility functions used by the xnode Qt UI.
 */
namespace GUIUtil
{
...
// Render xnode addresses in monospace font
...
// Parse "xnode:" URI into recipient object, return true on successful parsing
