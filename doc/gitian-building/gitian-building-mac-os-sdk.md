...
The script [extract-osx-sdk.sh](https://github.com/xnodevps-project/xnode/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
xnode/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/xnodevps-project/xnode/blob/master/doc/README_osx.md) for troubleshooting tips.
