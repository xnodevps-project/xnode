...
RESOURCES += src/qt/xnode.qrc src/qt/xnode_locale.qrc

TRANSLATIONS += src/qt/locale/xnode_bg.ts \
                src/qt/locale/xnode_de.ts \
                src/qt/locale/xnode_en.ts \
                src/qt/locale/xnode_es.ts \
                src/qt/locale/xnode_fi.ts \
                src/qt/locale/xnode_fr.ts \
                src/qt/locale/xnode_it.ts \
                src/qt/locale/xnode_ja.ts \
                src/qt/locale/xnode_pl.ts \
                src/qt/locale/xnode_pt.ts \
                src/qt/locale/xnode_ru.ts \
                src/qt/locale/xnode_sk.ts \
                src/qt/locale/xnode_sv.ts \
                src/qt/locale/xnode_vi.ts \
                src/qt/locale/xnode_zh_CN.ts \
                src/qt/locale/xnode_zh_TW.ts
